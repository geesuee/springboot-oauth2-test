...
import com.geesuee.springbootstudy.web.dto.HelloResponseDto;
...
public class HelloController {
    ...
    // /hello 로 요청이 오면 문자열 hello를 반환하는 기능
    public String hello() {
        return "hello";
    }
    ...
    public HelloResponseDto helloDto(@RequestParam("name") String name, @RequestParam("amount") int amount) {
        ...
        // 외부에서 name 이란 이름으로 넘긴 파라미터(@RequestParam("name"))를 메소드 파라미터 name 에 저장(String name)
